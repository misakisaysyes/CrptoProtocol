...
void make_cert(ZZ n,ZZ b,ZZ &r_p,ZZ &r_q,ZZ &r_n,ZZ &r_a,ZZ &r_b,ZZ &e_p,ZZ &e_aa,ZZ &e_bb,ZZ &e_a,int peo=1,bool first=true)
{
    int choose;
	do
	{
...
void main()
{
	 ...
	 get_p_q(p0,q0,1);//
	 create_sig_ver(p0,q0,n0,a0,b0,1);//
	 //cout<<"p="<<p<<" q="<<q<<" n="<<n<<" a="<<a<<" b="<<b<<endl;


	 Rsa(r_p,r_q,r_n,r_a,r_b,-35);
	 ELGamal(e_p,e_aa,e_bb,e_a);
	 make_cert(n,b,r_p,r_q,r_n,r_a,r_b,e_p,e_aa,e_bb,e_a,1);
	 make_cert(n0,b0,r_p,r_q,r_n,r_a,r_b,e_p,e_aa,e_bb,e_a,2);
